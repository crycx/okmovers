...

{
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_okmovers_quote_use_mailservice',
                'label' => 'Use mailservice for quote form',
                'name' => 'quote_form_use_mailservice',
                'type' => 'true_false',
                'instructions' => 'Kui lüliti on väljas, saadetakse hinnapäring tavalise emailina väljale "Quote recipient email".',
                'ui' => 1,
                'ui_on_text' => 'Mailservice',
                'ui_off_text' => 'Email',
                'default_value' => 1,
            ],
            [
                'key' => 'field_okmovers_quote_endpoint_url',
                'label' => 'Quote endpoint URL',
                'name' => 'quote_form_endpoint_url',
                'type' => 'url',
                'default_value' => 'https://emailservice.ermine.ee/quote',
                'conditional_logic' => [[[
                    'field' => 'field_okmovers_quote_use_mailservice',
                    'operator' => '==',
                    'value' => '1',
                ]]],
            ],
...

{
    ...
    if (in_array(get_option('options_quote_form_use_mailservice', null), [null, ''], true)) {
        $legacy_delivery_mode = sanitize_key((string) get_option('options_quote_form_delivery_mode', 'endpoint'));
        update_field('field_okmovers_quote_use_mailservice', $legacy_delivery_mode !== 'email' ? 1 : 0, 'option');
    }
