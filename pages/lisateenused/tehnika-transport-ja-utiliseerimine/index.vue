...
export default {
  ...
  head: function() {
    return {
      title: ' Tehnika transport ja utiliseerimine | OK Movers',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content:
            'Utiliseerime ja transpordime tehnikat – pole vahet kas vajate abi ühe printeri või saja monitoriga, saame alati aidata!'
        }
      ]
    }
  },
